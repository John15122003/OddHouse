...
// updated my ApparentRaisin to use Unity InputSystem
...
public class MouseLook : MonoBehaviour
{
	...
	void Update ()
	{
		...
		{			
			...
			rotationX += lookVector.x * sensitivityX * Time.timeScale;
		...
		{			
			...
			rotationY += lookVector.y * sensitivityY * invertFlag * Time.timeScale;
